...
function buildScripts() {
  return exec(
    `esbuild --bundle src/scripts/index.ts --outfile=build/script.js --minify`,
  )
}

function watchScripts() {
  return gulp.watch(['src/**/*.{ts,tsx}'], buildScripts)
}

function buildStyles() {
  return exec(`tailwindcss -i ./src/styles/style.css -o ./build/style.css`)
}
...
function buildContent() {
  return exec(`ts-node src/build/index.ts`)
}
